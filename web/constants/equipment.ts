...
export const EQUIPMENT: EquipmentItem[] = [
	{
		...
		icon: Weight,
		image: { src: "/images/equipment/free-weight-zone.jpg", alt: "The elite free-weight zone at Iron Elite Fitness Club" },
	},
	{
		id: "recovery-suite",
		...
		icon: Snowflake,
		image: { src: "/images/equipment/recovery-suite.jpg", alt: "The recovery and cryotherapy suite" },
	},
	{
		id: "cardio-deck",
		...
		icon: Activity,
		image: { src: "/images/equipment/cardio-deck.jpg", alt: "The precision cardio deck" },
	},
	{
		...
		icon: LayoutGrid,
		image: { src: "/images/equipment/functional-turf-zone.jpg", alt: "The functional turf training zone" },
	},
];
